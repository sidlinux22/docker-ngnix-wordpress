FROM ubuntu
MAINTAINER Siddharth Sharma <siddhartsharma@gmail.com>
...
# Basic Requirements
RUN apt-get -y install  nginx memcached php5-fpm php5-mysql php-apc pwgen python-setuptools curl git unzip openssh-server openssl
...
#Wordpress 
ADD ./wp-config.conf /usr/share/nginx/www/wp-config.conf 
